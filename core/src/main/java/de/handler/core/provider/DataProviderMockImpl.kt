...
class DataProviderMockImpl : DataProvider {
    ...
    override suspend fun getUsersAsync(): List<User> {
        ...
        return listOf(
            User(0, "Morton Cornelius", "mortoncornelius@gmail.com", "mortoncornelius", address, "https://picsum.photos/id/1084/367/267"),
            User(1, "Petreus Karakis", "pretreus.karakis@hotmail.com", "petreuskarakis", address, "https://picsum.photos/id/113/367/267")
        )
    }
